  ...
  <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300"
    ...
    <div class="section-container">
      <div class="flex justify-between items-center h-[72px]">
        ...
        <NuxtLink to="/" class="flex items-center gap-2.5 group">
          ...
          <div class="flex flex-col">
            <span class="text-lg font-bold leading-tight" :class="scrolled ? 'text-gray-900' : 'text-white'">
              OneSiam<span class="text-primary-500">Soft</span>
            </span>
            <span class="text-[10px] font-medium leading-none" :class="scrolled ? 'text-gray-400' : 'text-white/60'">
        ...
        <div class="hidden lg:flex items-center gap-1">
          ...
          <div class="w-px h-6 mx-2" :class="scrolled ? 'bg-gray-200' : 'bg-white/20'"></div>
      ...
      <Transition
        ...
        <div v-if="mobileMenuOpen" class="lg:hidden pb-4 space-y-1 bg-white rounded-xl mt-2 p-3 shadow-xl border border-gray-100">
