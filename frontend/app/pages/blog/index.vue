...
const posts = [
  ...
  { slug: 'choose-hosting', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&q=80', category: 'Hosting', categoryClass: 'bg-blue-500/10 text-purple-400 border border-blue-500/20', date: '8 ก.พ. 2026', readTime: '6 นาที', title: 'วิธีเลือก Web Hosting ที่เหมาะกับธุรกิจของคุณ', excerpt: 'แนะนำปัจจัยสำคัญในการเลือก hosting ตั้งแต่ความเร็ว ความเสถียร ไปจนถึงบริการหลังการขาย' },
